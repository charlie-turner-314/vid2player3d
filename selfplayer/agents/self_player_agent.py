...
class SelfPlayerAgent(common_agent.CommonAgent):
    ...
    def _eval_critic(self, obs_dict):
        ...
        obs_dict['obs'] = self._preproc_obs(obs_dict['obs']) # Normalise the observations
        value = self.model.a2c_network.eval_critic(obs_dict) # Get the value from the model
    ...
    def calc_gradients(self, input_dict):
        self.step_num = 0 if 'step_num' not in self.__dict__ else self.step_num + 1
